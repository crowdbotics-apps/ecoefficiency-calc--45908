"""
Django settings for ecoefficiency_calc__45908 project.
...
ROOT_URLCONF = 'ecoefficiency_calc__45908.urls'
...
WSGI_APPLICATION = 'ecoefficiency_calc__45908.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ecoefficiency_calc__45908 API",
    "DESCRIPTION": "API documentation for ecoefficiency_calc__45908 App",
    "VERSION": "v1",
}
